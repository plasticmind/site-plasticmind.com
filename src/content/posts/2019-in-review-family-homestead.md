---
title: "2019 In Review: Our Family and Homestead"
date: 2019-12-31 12:12:19
archive: false
excerpt: 
...
It’s been a long time since I wrote a year-end review.

So long, in fact, that I've attempted to capture highlights from multiple years and ended up turning it into a novel. Seems like the longer you go without documenting the big events from a given year, the more you feel like you need to include it in the next year’s review. At some point, all the years begin to blur together, and you end up with “a decade in review.” Let's just call this *2019(ish) In Review: The Novel*.
...
Most notably, we wanted to address a practical issue: whenever people would come visit, there was only one "public area" to hang out, and it had the television. So good conversations ended up happening in our kitchen, which meant a lot of standing around.
